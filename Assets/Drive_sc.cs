...
{
    // Variable controlling the forward motion speed of the object. The unit is meters per second.
    [SerializeField]
    float speed = 50.0f;
    ...
    void Update()
    {
        ...
        // This string represents sensor data from five directions (forward, right, left, forward-right 45 degrees, and forward-left 45 degrees) 
        // along with the rounded values of the translation and rotation inputs. It is used to record training data for the model.
